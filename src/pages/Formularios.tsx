...
const Formularios = () => {
  ...
  const getTipoColor = (tipo: string) => {
    switch (tipo) {
      case "Carta": return "bg-blue-100 text-blue-800";
      case "Demanda": return "bg-red-100 text-red-800";
      case "Solicitud": return "bg-green-100 text-green-800";
      case "Queja": return "bg-yellow-100 text-yellow-800";
      case "Aviso": return "bg-purple-100 text-purple-800";
      case "Registro": return "bg-indigo-100 text-indigo-800";
